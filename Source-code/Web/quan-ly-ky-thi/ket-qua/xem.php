...
try {
    ...
    // kiểm tra quyền truy cập (chỉ người tạo kỳ thi mới có quyền xem)
    if ($baiThi['nguoiTaoId'] != $_SESSION['user_id']) {
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-sm">
                                        ...
                                        <tr>
                                            <th>ngành:</th>
                                            <td><?php echo htmlspecialchars($baiThi['tenNganh'] ?? 'Chưa có thông tin'); ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
